...
class bayesian(object):
    ...
    def __calculate_maximum_likelyhood(self, data, labels):
        ...
        for _class in self.classes:
            ...
            covariances[_class] = mean_diff.T @ mean_diff
    ...
    def __normal_dist_max_aposteori(self, X):
        ...
        for class_ in self.classes:
            ...
            quadratic_form = (X - expected_value).T @ inv(covariance) @ (X - expected_value)
            log_likelyhood = -0.5 * (log(det(covariance) + 1e-10) + quadratic_form)
